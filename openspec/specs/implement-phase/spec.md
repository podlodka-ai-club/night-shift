...
## Purpose
TBD - created by archiving change implement-phase. Update Purpose after archive.
## Requirements
...
- **THEN** the comment body lists the quality-gate failures verbatim
