# TaskFlow — demo project for the specify-phase eval harness

A small fictional product used as the *world-model* for eval fixtures.
Specifier prompts that reference TaskFlow features should plausibly find
context here. The project does not exist as code; it exists only as a
description rich enough that ticket bodies feel realistic.
